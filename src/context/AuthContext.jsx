...
//         // error NON deve bloccare tutto (RLS/manca tabella/etc.)
//         if (readErr) console.warn("profiles read error:", readErr);

//         // 2) se manca, crea un fallback e upsert
...
//         const { username } = await ensureProfile(sessionUser);
//         return {
//             id: sessionUser.id,
...
//         // data.user esiste, ma noi ci affidiamo anche a onAuthStateChange
//         return data;
//     };
...
//             password,
//             options: {
//                 data: { name }, // salvato in user_metadata
//             },
//         });
//         if (error) throw error;

//         // con email confirm ON: session spesso null → ok così
//         return data;
//     };
...
//         if (error) throw error;
//         // onAuthStateChange metterà user=null
//     };

//     useEffect(() => {
//         let alive = true;

//         // watchdog: evita "Syncing..." infinito in dev
//         const watchdog = setTimeout(() => {
//             if (!alive) return;
//             console.warn("AUTH WATCHDOG: forcing authLoading=false");
...
//                 setUser(u);
//             } catch (e) {
//                 console.error("AuthProvider load crashed:", e);
//                 if (!alive) return;
//                 setUser(null);
//             } finally {
//                 if (!alive) return;
...
//                 setUser(u);
//             } catch (e) {
//                 console.error("onAuthStateChange crashed:", e);
//                 if (!alive) return;
//                 setUser(null);
//             } finally {
//                 if (!alive) return;
